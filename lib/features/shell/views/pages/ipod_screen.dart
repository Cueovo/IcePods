...
import 'package:qqmusic_ipod/features/shell/views/pages/wake_diag_screen.dart';
...
class _IpodScreenState extends State<IpodScreen> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    unawaited(DeviceDisplayMetrics.markWakeDiag('flutter.${state.name}'));
  ...
  Future<void> _openWakeDiag() async {
    await DeviceDisplayMetrics.markWakeDiag('openWakeDiagViewer');
    ...
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
        ...
        builder: (_) => WakeDiagScreen(initialLines: lines),
      ),
    );
  }
