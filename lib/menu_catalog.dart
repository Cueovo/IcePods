...
const swaggerMenuOperations = <String>{
  'GET /recommend/get_guess_recommend',
  'GET /recommend/get_home_feed',
  'GET /recommend/get_radar_recommend',
  'GET /recommend/get_recommend_newsong',
  'GET /recommend/get_recommend_songlist',
  'GET /search/general_search',
  'GET /login/qrcode/{login_type}',
  'GET /top/get_category',
  'GET /singer/get_singer_list',
  'GET /user/{euin}/fav/songs',
  'GET /user/{euin}/fav/albums',
  'GET /user/{euin}/fav/mvs',
  'GET /user/{euin}/follow/singers',
  'GET /user/{uin}/created_songlists',
  'GET /user/{euin}/fav/songlists',
  'GET /user/dislikes',
};
